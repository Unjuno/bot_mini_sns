...
$hexSignature = hash_hmac('sha256', 'v0:'.$slackTimestamp.':'.$signedBody, 'secret');
if (!verify_slack_signature($signedBody, 'secret', $slackTimestamp, 'v0='.$hexSignature)) throw new RuntimeException('Slack signature contract failed');
if (verify_slack_signature($signedBody, 'secret', $slackTimestamp, 'v0=invalid')) throw new RuntimeException('invalid Slack signature accepted');
